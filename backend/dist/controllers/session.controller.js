...
var SessionService = __importStar(require("../services/session.service"));
...
var list = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, SessionService.getAllSessions()];
            case 1:
                sessions = _a.sent();
                res.json(sessions);
                return [2 /*return*/];
...
var create = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, SessionService.createSession(req.body)];
            case 1:
                newSess = _a.sent();
...
var getOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, SessionService.getSessionById(req.params.id)];
            case 1:
                sess = _a.sent();
                if (!sess) {
                    res.sendStatus(404);
